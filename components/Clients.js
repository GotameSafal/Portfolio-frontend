      ...
      >
        <div class="grid gap-6 sm:grid-cols-2">
          ...
          <div class="bg-grey-lighter flex w-full items-center justify-center">
            <label class="text-blue border-blue hover:bg-blue flex w-64 cursor-pointer flex-col items-center rounded-lg border bg-white px-4 py-6 uppercase tracking-wide shadow-lg hover:text-gray-200">
        ...
        <button
          type="submit"
          class="mt-5 w-full rounded-md font-bold bg-black px-10 py-2 text-white"
        >
          Add
        </button>
      </form>
